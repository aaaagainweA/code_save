...
if __name__ == '__main__':
    ...
    df_last7days = pd.read_excel('last7days.xlsx')
    df_last7days = df_last7days.loc[df_last7days['clue_state_name']=='新线索', ['telephone', 'advertiser_name']]
    df_last7days.rename(columns={df_last7days.columns[0]: 'phone',df_last7days.columns[1]: '广告主名称'}, inplace=True)

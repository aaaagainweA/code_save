...
if __name__ == '__main__':
    ...
    group1.to_excel(f'D:/导线数据/{now_time}(16-9)组一.xlsx', index=False)

    group2.to_excel(f'D:/导线数据/{now_time}(16-9)组二.xlsx', index=False)
    ...
    test_report = f'D:/导线数据/{now_time}(16-9).xlsx'
    test_report1 = f'D:/导线数据/{now_time}(16-9)组一.xlsx'
    test_report2 = f'D:/导线数据/{now_time}(16-9)组二.xlsx'

...
df_clue=pd.read_excel(f'D:/导线数据/{now_time}(0-24).xlsx')
...
df_channel2.rename(columns={df_channel2.columns[0]:'地区',df_channel2.columns[1]:'文案编号',df_channel2.columns[3]:'表单进线'},inplace=True)
...
df_city1.rename(columns={df_city1.columns[0]:'地区',df_city1.columns[1]:'总广告费',df_city1.columns[2]:'总进线',df_city1.columns[3]:'总单粉成本'},inplace=True)
...
df_result = df_result.loc[:,
            ['大区', '门店名称', '城市','总成交人数', '总成交金额', '总退款金额','体验卡退款金额','体验卡退款数量', '实际成交金额', '退款率', '充值人数', '充值金额', '充值占比', '商品购买人数',
             '商品订单金额', '商品订单金额占比',
...
df_advertise=df_result.loc[:,['城市','新客到店人数','老客到店人数','售卡人数','售卡金额','升单人数','升单金额','复购成交人数','复购成交金额','实际成交金额','总退款金额','总成交金额']]
...
df_temp_table=df_temp_table.loc[:,['负责人', '大区', '省份', '城市', '广告总额', '进线成本', '进线人数', '系统重粉数','表单重粉数','重粉数', '重粉率','有效进线成本','到店成本','总到店人数', '新客到店人数',
